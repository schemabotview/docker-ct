...
all in `README.md`, each mapped to a real `dk-*` scene node). **Modules 01–04 authored
end-to-end** (40 sections, `.ipynb` + `.slide` + `.tts`, wired in `manifest.json`); modules
01–03 pushed. `audio/` empty pending the owner's Colab run.
