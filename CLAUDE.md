...
all in `README.md`, each mapped to a real `dk-*` scene node). **Modules 01–05 authored
end-to-end** (50 sections, `.ipynb` + `.slide` + `.tts`, wired in `manifest.json`); modules
01–04 pushed. `audio/` empty pending the owner's Colab run.
