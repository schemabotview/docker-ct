...
all in `README.md`, each mapped to a real `dk-*` scene node). **Modules 01–03 authored
end-to-end** (30 sections, `.ipynb` + `.slide` + `.tts`, wired in `manifest.json`); modules
01–02 pushed. `audio/` empty pending the owner's Colab run.
